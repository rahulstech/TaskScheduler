...
import rahulstech.android.taskschedulder.adapter.TaskListAdapter;
import rahulstech.android.taskschedulder.listener.OnClickItemOrChildListener;
import rahulstech.android.taskschedulder.viewmodel.TaskListViewModel;
import rahulstech.android.util.time.DateTime;

import static rahulstech.android.taskschedulder.util.Constant.ACTION_ADD_TASK;
...
public class TaskListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnAddTask.setOnClickListener(v->onClickAddTask());
    ...
    void onClickAddTask() {
        ...
        i.setAction(ACTION_ADD_TASK);
        i.putExtra(EXTRA_DATE,mTaskDate.formatISODate());
        startActivity(i);
    }
